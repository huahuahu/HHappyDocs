//
//  HLocationConvertor.swift
//  HSharedCode
//
//  Created by tigerguo on 2025/3/16.
//
// WGS-84 全球通用的地理坐标系
// GCJ-02 中国坐标偏移标准，也称为“火星坐标系“，中国大陆地区的大多数地图服务（如高德地图、腾讯地图、百度地图等）都使用GCJ-02坐标系。
// https://github.com/TinyQ/TQLocationConverter
#if os(iOS)
  import CoreLocation
  import Foundation

  public enum HLocationConvertor {
    public static func gpsCoordinate(fromMarsCoordinate coordinate: CLLocationCoordinate2D) -> CLLocationCoordinate2D {
    ...
    public static func marsCoordinate(fromGPSCoordinate coordinate: CLLocationCoordinate2D) -> CLLocationCoordinate2D {
    ...
    private static func isLocationOutOfChina(_ location: CLLocationCoordinate2D) -> Bool {
    ...
    private static func polygonOfChina() -> [NSValue] {
